    ...
    <div className="web-team">
      ...
      <Container fluid>
        <Row>
          ...
          <Col lg={3} md={6} sm={12}>
            <TeamMemberCard linkedin='https://www.linkedin.com/in/fatema-katawala-2b99451a1/'  name='Fatema Katawala' image={Fateema} />
          </Col>
          <Col lg={3} md={6} sm={12}>
      ...
      <Container fluid>
        <Row>
          <Col lg={3} md={6} sm={12}>
            <TeamMemberCard linkedin='https://www.linkedin.com/in/rakmo33/' name='Omkar Dabir' image={Omkar} />
          </Col>
          ...
          <Col lg={3} md={6} sm={12}>
            <TeamMemberCard linkedin='https://www.linkedin.com/in/shreya-deshpande-420297191/' name='Shreya Deshpande' image={Shreya} />
          </Col>
        </Row>
      </Container>
    </div>
