                      ...
                      <Col className="d-flex align-items-center col-inner">
                        <div className="carousel-text-inner">
                          ...
                          <p className="lead text-justify carousel-para">
                            ...
                            expertise among people all over the globe. IEEE
                            continues to attract students, faculty and
                            professionals from various fields all around the
                            world and is committed to incorporate diversity in
                            thoughts which is essential for scientific
                            development. IEEE currently has Student Branches at
                            thousands of universities and colleges in hundreds
                      ...
                      <Col className="d-flex align-items-center col-inner">
                        <div className="carousel-text-inner">
                          ...
                          <p className="lead text-justify  carousel-para">
                            ...
                            Credenz Tech Dayz with the first one being conducted
                            in the even semester and the second one in the odd
                            semester. PISB is also marked by its Women in
                            Engineering (WIE) chapter, an initiative for
                            impowerment of women in the technical domain. PISB
                            has been awarded the Best Student Branch of IEEE in
                            Pune section.
                          </p>
                        </div>
                      </Col>
                      ...
                      <Col className="d-flex align-items-center col-inner">
                        <div className="carousel-text-inner">
                          ...
                          <p className="lead text-justify  carousel-para">
                            ...
                            technical ingenuity. It highlights articles on
                            cutting-edge technologies from technocrats all
                            around the globe including students, industrialists
                            and faculty members. P.I.N.G. serves as a platform
                            ...
                            including students, industrialists and faculty
                            members. It also features interviews of
                            distinguished personalities in various technical
                            domains.
                          </p>
                        </div>
                      </Col>
